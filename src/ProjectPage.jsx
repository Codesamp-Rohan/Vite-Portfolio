export function ProjectPage(){
    const projectDetails = [
        {img: "/Projects/sibiro.png", sideImg: "/Projects/sibiro--menu.png", content: "empowers developers to complete tasks 55% faster with contextualized AI coding assistance across workflows.", exploreLinksBtn: "Explore SIBIRO", exploreLinks: "https://sibiro.ru", quickLinksBtn: "sibiro.ru", blob: "6e40c999"},
        {img: "/Projects/docyard.png", sideImg: "/Projects/docyard--menu.png", content: "empowers developers to complete tasks 55% faster with contextualized AI coding assistance across workflows.", exploreLinksBtn: "Explore DOCYARD", exploreLinks: "https://docyard.co.in", quickLinksBtn: "docyard.co.in", blob: "97ee8199"},
        {img: "/Projects/portfolio.png", sideImg: "/Projects/portfolio--menu.png", content: "empowers developers to complete tasks 55% faster with contextualized AI coding assistance across workflows.", exploreLinksBtn: "Explore PREVIOUS PORTFOLIO", exploreLinks: "https://codesamp-rohan.github.io/Port-Folio/", quickLinksBtn: "previous-portfolio.me", blob: "EECF8159"},
        {img: "/Projects/cosmetics.png", sideImg: "/Projects/cosmetics--menu.png", content: "empowers developers to complete tasks 55% faster with contextualized AI coding assistance across workflows.", exploreLinksBtn: "Explore COSMETICS", exploreLinks: "https://codesamp-rohan.github.io/Cosmetics/", quickLinksBtn: "cosmetics.me", blob: "eeeeee59"},
        {img: "/Projects/quasar.png", sideImg: "/Projects/quasar--menu.png", content: "empowers developers to complete tasks 55% faster with contextualized AI coding assistance across workflows.", exploreLinksBtn: "Explore QUASAR", exploreLinks: "/", quickLinksBtn: "quasar", blob: "395B30FF"}
    ]
