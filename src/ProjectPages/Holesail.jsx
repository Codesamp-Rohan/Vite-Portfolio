...
export function Holesail({ isTheme }) {
...
const Slider = ({ pageSize, handleSize }) => {
  ...
  const images = [
    "/Projects/holesail-1.png",
    "/Projects/holesail-2.png",
    "/Projects/holesail-3.png",
  ];
