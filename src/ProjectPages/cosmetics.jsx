        ...
        <>
            ...
            <div>
                <div className="h-[60vh] top--section relative border-b-[1px] border-b-[#404246] dark:border-b-[#cbcbcb] dark:bg-[#fff]">
                    <span className={`${isTheme ? "l--project--img" : "project--img"} z-[20] w-[100%] h-[100%] absolute text-[#000] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] dark:text-[#fff]`}></span>
                    <img className="project--img absolute h-full w-full object-cover z-[19] " src="/Vite-Portfolio/Projects/cosmetics.png" alt="bg-img"></img>
...
const Slider = ({ pageSize, handleSize }) => {
    ...
    const images = [
        '/Vite-Portfolio/Projects/cosmetics.png',
        '/Vite-Portfolio/Projects/cosmetics-2.png',
        '/Vite-Portfolio/Projects/cosmetics-3.png'
    ];
