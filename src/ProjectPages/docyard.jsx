...
export function Docyard({isTheme}){
    ...
    return (
        <>
            ...
            <div>
                <div
                    className="h-[60vh] top--section relative border-b-[1px] border-b-[#404246] dark:border-b-[#cbcbcb] dark:bg-[#fff]">
                    <span
                    ...
                    <img className="project--img absolute h-full w-full object-cover z-[19] "
                         src="/Vite-Portfolio/Projects/docyard.png" alt="bg-img"></img>
                    <span className="absolute w-[100%] h-[100%] z-[50] flex items-end px-[30px]">
                        <h1 className="text-[10vw]">DOCYARD</h1>
                    </span>
                </div>
            </div>
...
const Slider = ({pageSize, handleSize}) => {
    ...
    const images = [
        '/Vite-Portfolio/Projects/docyard.png',
        '/Vite-Portfolio/Projects/docyard-2.png',
        '/Vite-Portfolio/Projects/docyard-3.png'
    ];
    ...
    return (
        <div className="relative flex justify-center border-y-[0.2px] border-y-[#404246] py-[100px] dark:border-y-[#cbcbcb] dark:bg-[#fff]">
            ...
            <animated.div style={props}>
                ...
                }} className="rounded-xl border-[0.5px] border-[#000]" src={images[index]} alt={`Image ${index + 1}`}/>}
            </animated.div>
        </div>
    );
};
        ...
        <>
            <div className="single--project--content flex justify-center px-[100px] pb-[200px] dark:bg-[#fff] dark:text-[#000]">
                <div className="single--project--content--container flex justify-between py-[10px]">
                    ...
                    <h1 className="single--project--heading text-[#97ee81] dark:text-[#65B741]">Project Details</h1>
                        <span
