...
export function Quasar({isTheme}){
        ...
        <>
            ...
            <div>
                <div className="h-[60vh] top--section relative border-b-[1px] border-b-[#404246] dark:border-b-[#cbcbcb]">
                    ...
                    <img className="project--img absolute h-full w-full object-cover z-[19] " src="/Vite-Portfolio/Projects/quasar.png" alt="bg-img"></img>
                    <span className="absolute w-[100%] h-[100%] z-[50] flex items-end px-[30px]">
                        <h1 className="text-[10vw]">QUASAR</h1>
                    </span>
                </div>
            </div>
...
const Slider = ({ pageSize, handleSize }) => {
    ...
    const images = [
        '/Vite-Portfolio/Projects/quasar.png',
        '/Vite-Portfolio/Projects/quasar-2.png',
        '/Vite-Portfolio/Projects/quasar-3.png'
    ];
