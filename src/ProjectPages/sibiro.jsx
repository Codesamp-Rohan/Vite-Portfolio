...
export function Sibiro({istTheme}){
    ...
    return (
        <>
            <Navbar />
            <div>
                <div className="h-[60vh] top--section relative border-b-[1px] border-b-[#404246] dark:border-b-[#cbcbcb]">
                    <span className="project--img z-[20] w-[100%] h-[100%] absolute text-[#000] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"></span>
                    <img className="project--img absolute h-full w-full object-cover z-[19] " src="/Vite-Portfolio/Projects/sibiro.png" alt="bg-img"></img>
...
const Slider = ({ pageSize, handleSize }) => {
    ...
    return (
        <div className="relative flex justify-center border-y-[0.2px] border-y-[#404246] py-[100px] dark:bg-[#fff]">
            ...
            <animated.div style={props}>
                ...
                }} className="rounded-xl dark:border-[#000] dark:border-[0.5px]" src={images[index]} alt={`Image ${index + 1}`}/>}
            </animated.div>
        </div>
    );
};
