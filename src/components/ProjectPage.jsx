...
export function ProjectPage({ active, isTheme }){
    ...
    const projectDetails = [
        {img: "/Vite-Portfolio/Projects/sibiro.png", sideImg: "/Vite-Portfolio/Projects/sibiro--menu.png", content: "is a website of a client from Russia who has a furniture business and I designed the Front-End part of his website.", exploreLinksBtn: "Explore SIBIRO", exploreLinks: "/Vite-Portfolio/sibiro", quickLinksBtn: "sibiro.ru", blob: "6e40c999", dataValue: "1"},
        {img: "/Vite-Portfolio/Projects/docyard.png", sideImg: "/Vite-Portfolio/Projects/docyard--menu.png", content: "a freelancing agency and social-media platform. I developed the complete website of them from designing to development to deployment to maintaince.", exploreLinksBtn: "Explore DOCYARD", exploreLinks: "/Vite-Portfolio/docyard", quickLinksBtn: "docyard.co.in", blob: "97ee8199", dataValue: "2"},
        {img: "/Vite-Portfolio/Projects/portfolio.png", sideImg: "/Vite-Portfolio/Projects/portfolio--menu.png", content: "is my previous portfolio when I was new to JavaScript and was full on `code-eroids` to develop a personal portfolio for me.", exploreLinksBtn: "Explore PREVIOUS PORTFOLIO", exploreLinks: "/Vite-Portfolio/portfolio", quickLinksBtn: "previous-portfolio.me", blob: "EECF8159", dataValue: "3"},
        {img: "/Vite-Portfolio/Projects/cosmetics.png", sideImg: "/Vite-Portfolio/Projects/cosmetics--menu.png", content: "is a simple template I designed and developed for a cosmetics startup. We can convert it for a cafe or restaurent too.", exploreLinksBtn: "Explore COSMETICS", exploreLinks: "/Vite-Portfolio/cosmetics", quickLinksBtn: "cosmetics.me", blob: "eeeeee59", dataValue: "4"},
