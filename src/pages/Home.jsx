...
export default function Home() {
  ...
  return (
    <>
      ...
      <Main />
      <GithubSection
        handleGithubImg={handleGithubImg}
        pageSize={pageSize}
        isTheme={isTheme}
    ...
    <div className="flex AppScroll relative items-center border-b-[0.5px] border-b-[#404246] overflow-hidden dark:bg-[#fff] dark:border-[1px] dark:border-b-[#cbcbcb]">
      <div className="main--title border-r-[0.5px] border-r-[#404246] h-[60vh] px-[2rem] flex items-center dark:border-r-[#cbcbcb] dark:border-r-[1px] z-[30]">
        <h1 className="home-section-content text-[5rem] line-height-[10px] text-[#424769] w-[60vw] dark:text-[#888]">
          ...
          {/*strategy & innovation.*/}
          <strong className="text-[#eee] dark:text-[#7743db]">
            Better
          </strong>{" "}
          and{" "}
          <strong className="text-[#eee] dark:text-[#7743db]">
            enhanced Web Developer
          </strong>{" "}
          than Spiderman itself.
        </h1>
        <img
          className="w-[1200px] rotate--svg--at--heading z-[1] opacity-[10%] absolute top-[10%] left-[-40%] dark:opacity-[20%]"
          src="/Icons/pattern--2.svg"
          alt="pattern--icons"></img>
      </div>
    ...
    <>
      <div className="border-t-[0.2px] relative border-t-[#404246] pb-[100px] flex justify-center dark:bg-[#fff]">
        <span className="w-[80vw] divide-y-[0.2px] divide-[#404246]">
          <p className="heading--para text-[18px] py-[30px] dark:text-[#65B741]">
            About Me:
          </p>
          <h1 className="description text-[40px] text-justify text-[#fff] py-[30px] dark:text-[#000]">
            ...
            I am a Web Developer and Desktop App Developer and UI/UX Designer. I
            have 2+ years of experience. My mission is to be best in my skill
            and give the best result from my hardwork and dedication.
...
function TechMarquee({ isTheme }) {
  const skills = [
    ...
    { name: "Express Js", img: "/Icons/react.png" },
    { name: "MongoDB", img: "/Icons/mongodb.png" },
    { name: "Node Js", img: "/Icons/nodejs.png" },
    { name: "Electron Js", img: "/Icons/electron.png" },
    {
      name: "Tailwind CSS",
  ...
  return (
    <>
      <div className="flex w-[100vw] overflow-hidden py-[1rem] relative border-y-[0.2px] border-[#404246] dark:bg-[#f6f8fa] dark:border-y-[1px] dark:border-y-[#cbcbcb] dark:text-[#000]">
        <div
          className={`isTheme ? "marquee-fade w-full h-full" : "l--marquee-fade w-full h-full"`}></div>
        <motion.div
          initial={{ x: 0 }}
          animate={{ x: "-100%" }}
